...
class Person(var name : String , val age : Int){
  ...
  def this( age : Int, gender : String){
    this("", age)
    this.gender = gender
  }
}
...
class Student(name : String , age : Int, val major : String) extends Person(name, age){
  ...
  override def toString = "Override toString..."+school

}

object Student{
  def apply(name : String , age : Int,  major : String) = new Student(name,age,major)
